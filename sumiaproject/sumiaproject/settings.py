"""
Django settings for sumiaproject project.
...
SECRET_KEY = 'django-insecure-1dnlf)o9zlw2p(=)+5-ibv=)#z(1jd+b6p6kyac$hxeyn+9!#8'
...
ROOT_URLCONF = 'sumiaproject.urls'
...
WSGI_APPLICATION = 'sumiaproject.wsgi.application'
